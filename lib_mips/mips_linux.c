...
#include "../ecdsa_lightweight/ecc.c"
	...
	uint8_t signature_example2[] = { 0x84, 0x5A, 0x12, 0xC2, 0x9C, 0x08, 0x75, 0x0E, 
		0xFB, 0x16, 0xE4, 0xDF, 0x6E, 0x93, 0x6D, 0xB8, 
		0xAC, 0x12, 0x19, 0x96, 0xDA, 0x5C, 0x05, 0xC4, 
		0x93, 0xD1, 0x3E, 0xCB, 0xC3, 0x3F, 0x55, 0x67, 
		0x32, 0xBC, 0xC2, 0xDD, 0xAC, 0xF3, 0x4F, 0xF4, 
		0x80, 0x33, 0xB4, 0x7E, 0xEB, 0x3F, 0x2F, 0x3F, 
	...
	if (re == 1)printf("eg1 verify result: valid\n");
	else printf("eg1 verify result:  NOT valid\n");
